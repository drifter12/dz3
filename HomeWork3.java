...
Здравствуйте, моя среда разработки предложила исправить ваш код для проверки второго задания ради работоспособности кода, с исправлениями всё работает корректно. 
Я неправильно выполнил задание, это конфликт версий или какие-то проблемы с кодом проверки?
Скажите пожжалуйста, стоило/стоит ли исправлять ошибки в коде проверки домашнего задания?
